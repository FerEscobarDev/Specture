...
function compute() {
  ...
  for (const name of ["ROADMAP_TEMPLATE.md", "SPEC_TEMPLATE.md", "MIGRATION_SPEC_TEMPLATE.md", "CURRENT_CAPABILITY_TEMPLATE.md", "BUSINESS_REQUIREMENTS_TEMPLATE.md", "PLANNING_TEMPLATE.md", "NAVIGATION_MAP_TEMPLATE.md", "DESIGN_SYSTEM_TEMPLATE.md", "COMPONENT_REFERENCE_TEMPLATE.md", "BRAND_BRIEF_TEMPLATE.md"]) {
