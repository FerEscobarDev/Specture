...
This skill **fuses** what previous versions split into "arquitectura" and "generador-roadmap". Architecture without a plan is wishful thinking; a plan without architecture is fiction.
...
- Input: `architecture.md` + `.specture/stack.yml` + `.specture/conventions.md` + `.specture/decisions/`.
...
Announce in Spanish:
> "Arquitectura aprobada por el validator y ROADMAP generado en `docs/04-roadmap/ROADMAP.md`. Por favor revísalo. Cuando estés listo, podemos pasar a la Fase 3 (UX) si tienes frontend, o directamente a la Fase 4 (build) para empezar a construir el primer epic."
